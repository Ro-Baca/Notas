...
# Nivelación
---
Existen 3 tipos de nivelaciones para la cama de impresión.
- **Nivelación Manual:** El usuario participa totalmente.
- **Semi-automatica:** La maquina usa sensores para crear un plano, asi el usuario puede corregir las niveles erroneos.
- **Automático:** La maquina nivela y renivela automaticalente; algunas incluso te permiten tener un offset en la impresora.
## Nivelacion manual
1. Usa la impresora para mandar al extrusor a *Home* o la coordenada (0,0,0).
2. Usando un hoja de papel, colocala entre la base y la boquilla.
3. En cada esquina: ajustar con las perillas la altura de la cama, con la intensión de poder mover la hoja con un poco de dificultad.
4. Mandar un objeto pequeño a imprimir en cada esquina y ajustar la distancia manualmente durante la impresión.
